...
# Well Knowns: Purchase fresh infrastructure signal data and enrich company entries
echo "--- Purchasing Well Knowns data (x402) ---"
node scripts/buy_wellknowns_data.js || echo "  ⚠ Well Knowns purchase had warnings (non-blocking)"
echo ""

echo "--- Enriching with Well Knowns signals ---"
python3 scripts/enrich_wellknown_signals.py || echo "  ⚠ Well Knowns enrichment had warnings (non-blocking)"
echo ""
